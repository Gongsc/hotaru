...
The search script lives inside this skill's own directory (its base directory: `.zcode/skills/ui-ux-pro-max/` under the project root), not the project directory. Always invoke it by its full path — do not assume a particular working directory:
